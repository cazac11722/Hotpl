    ...
    return (
        <section className="text-white">
            <div className="container m-auto">
                ...
                <div className='mt-4 pt-8 px-4 border-t border-neutral-900'>
                    <input type="text" id="first_name" class="text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-zinc-700 dark:border-gray-600 dark:text-white " placeholder="대회 제목을 입력해주세요." required />
                </div>
                <ul className='text-black dark:text-white mt-4'>
                    <li className='flex justify-between mb-10 border-b border-neutral-900 px-4 py-8'>
                        <div className='w-2/5'>
                        ...
                        <div className='w-3/5 px-4 relative'>
                            ...
                            <div>
                                ...
                                <div className='flex items-center text-xs'><Schedule className='fill-white w-4 mr-1' /> 접수 기간 입니다.</div>
                            </div>
                            <p className='text-xs absolute bottom-0 right-0 px-3 py-1 rounded-sm bg-sky-700'>진행중</p>
                        </div>
                    </li>
                    <li className='flex justify-between mb-10 border-b border-neutral-900 px-4 py-8'>
                        <div className='w-2/5'>
                        ...
                        <div className='w-3/5 px-4 relative'>
                            ...
                            <p className='text-xs absolute bottom-0 right-0 px-3 py-1 rounded-sm bg-green-700'>접수기간</p>
                        </div>
                    </li>
                    <li className='flex justify-between mb-10 border-b border-neutral-900 px-4 py-8'>
                        <div className='w-2/5'>
                        ...
                        <div className='w-3/5 px-4 relative'>
                            ...
                            <p className='text-xs absolute bottom-0 right-0 px-3 py-1 rounded-sm bg-red-700'>접수마감</p>
                        </div>
                    </li>
                </ul>
            </div>
