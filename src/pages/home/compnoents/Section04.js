...
const Section04 = ({ title, data, link }) => {
    ...
    return (
        <section className="text-white py-4 lg:py-6 lg:px-6 overflow-hidden">
            <div className='flex items-center justify-between px-4'>
                <h3 className="text-1xl font-black text-white lg:text-2xl">{title} TOP <span className='font-monoton'>10</span></h3>
                <Link to={link}><ChevronRight className='fill-white' /></Link>
            </div>
            <div className='flex mt-4'>
                <Swiper
                    className="text-black px-4 m-0 w-full  overflow-visible"
                    speed={500}
                    spaceBetween={10}
                    slidesPerView={'auto'}
                >
